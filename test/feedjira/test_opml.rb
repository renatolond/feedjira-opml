...
module Feedjira
  class TestOpml < Minitest::Test
    describe "Parser" do
      before do
        file = File.open(File.expand_path("../fixtures/basic.opml", __dir__), "r")
        xml = file.read
      ...
      describe "for outlines" do
        before do
          file = File.open(File.expand_path("../fixtures/outline.opml", __dir__), "r")
          xml = file.read
      ...
      describe "for subscription lists" do
        before do
          file = File.open(File.expand_path("../fixtures/subscription-list.opml", __dir__), "r")
          xml = file.read
